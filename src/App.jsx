...
const LoginPage = lazy(() => import('./patientLogin'));
const SignupPage = lazy(() => import('./Signup'));
const DoctorsPage = lazy(() => import('./doctor'));
const PatientDashboard = lazy(() => import('./PatientDashboard'));
const DoctorDashboard = lazy(() => import('./DoctorDashboard'));
const PrivacyPolicy = lazy(() => import('./PrivacyPolicy'));
const TermsOfService = lazy(() => import('./TermsOfService'));
const DoctorViewProfile = lazy(() => import('./DoctorViewProfile'));
const ContentHub = lazy(() => import('./ContentHub'));
const AdminDashboard = lazy(() => import('./AdminDashboard'));
const AdminLogin = lazy(() => import('./AdminLogin'));
const MiniBot = lazy(() => import('./components/MiniBot'));
const ChatbotApp = lazy(() => import('./Chatbot/App'));
const DoctorRegistration = lazy(() => import('./DoctorRegistration'));
const PatientProfilePage = lazy(() => import('./PatientProfilePage'));
   ...
   return (
      <div className="min-h-screen bg-[#F0F8F8] font-sans text-slate-900 pb-8 pt-4 cursor-default selection:bg-teal-100 selection:text-teal-900 overflow-x-hidden">
         <div className="mx-px space-y-6">
            ...
            <div id="how-it-works" className="bg-white rounded-[2.5rem] p-10 md:p-16">
...
export default function App() {
   ...
   return (
      <main className="relative min-h-screen">
         ...
         <Suspense fallback={<div className="min-h-screen flex items-center justify-center bg-[#F0F8F8] text-teal-800 font-medium">Loading Page...</div>}>
          {currentPage === 'home' && (
          ...
          {currentPage === 'doctors' && (
             ...
             <DoctorsPage
                onBack={() => navigateTo('home')}
                onViewProfile={(doc) => navigateTo('doctor-view', doc)}
                onNavigateDoctorRegistration={() => window.open('/doctor-registration', '_blank')}
                onNavigateAboutTeam={navigateToAboutTeam}
                onNavigateDoctors={() => navigateTo('doctors')}
                onNavigateHowitWorks={() => navigateToSection('how-it-works')}
         ...
         <div className={`fixed inset-0 z-[200] bg-white transition-opacity ${currentPage === 'chatbot' ? 'opacity-100 pointer-events-auto' : 'opacity-0 pointer-events-none'}`}>
            ...
            <ChatbotApp onViewProfile={(doc) => navigateTo('doctor-view', doc)} />
         </div>
