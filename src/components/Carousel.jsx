...
import { ShieldCheck, AlertCircle, CheckCircle, Search, Cpu } from 'lucide-react';
import './Carousel.css';
...
const ITEMS = [
  ...
  {
    title: 'Smart Search',
    description: 'Advanced AI-powered search to find the right healthcare provider for your needs.',
    id: 4,
    icon: <Search className="carousel-icon" />
  },
  {
    title: 'AI Guidance',
    description: 'Personalized recommendations based on your medical history and preferences.',
    id: 5,
